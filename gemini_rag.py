...
template = """You should reply like Bit Assit as your name and based only on the following context:
{context} 

Return you answer as string and make sure your response to user must be complete 
